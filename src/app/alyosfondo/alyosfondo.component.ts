...
export class AlyosfondoComponent {
  ...
  ngOnInit(): void {
    ...
    this.scuro_chiara = [
      {src: this.alyo.percorso_sito+"assets/immagini/sfondo/chiaro.jpg",valore: true},
      {src: this.alyo.percorso_sito+"assets/immagini/sfondo/scuro.jpg" ,valore: false}
    ]
  
    this.sfondi = {
      true:  this.alyo.percorso_sito+"assets/immagini/sfondo/sfondo.gif",
      false: this.alyo.percorso_sito+"assets/immagini/sfondo/sfondofluo.gif"
    }
  }
